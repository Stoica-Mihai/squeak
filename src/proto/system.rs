...
pub fn set_debounce(dev: &mut dyn Hid, ms: u8) -> Result<u8, HidError> {
...
pub fn set_sleep(dev: &mut dyn Hid, minutes: u8) -> Result<u8, HidError> {
...
pub fn factory_reset(dev: &mut dyn Hid) -> Result<(), HidError> {
