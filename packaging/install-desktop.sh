...
install -Dm644 crates/squeak-desktop/icons/icon.png \
  "$data/icons/hicolor/512x512/apps/squeak-desktop.png"
...
echo "uninstall: sudo rm /usr/local/bin/squeak-desktop; rm $data/applications/squeak-desktop.desktop $data/icons/hicolor/512x512/apps/squeak-desktop.png"
